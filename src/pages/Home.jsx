      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 md:pl-12 py-7">
            ...
            {/* widgets */}
            <div className="widgets-contianet flex flex-col md:flex-row md-space-between items-center md:items-start w-full">
              <div className="w-1/2 py-5 space-x-4">
                <div className="widget-container py-4 flex flex-col items-center md:flex-row md:items-start">
                  <div className="widget-icon-container md:mr-1">
                    <BiRectangle className="text-5xl text-[#ff702d]" />
                  </div>
                  <div className="widget-content flex-center flex-col text-center md:text-left">
                    <h3 className="text-4xl md:text-4xl">Architecture</h3>
                    <p className="mt-2">
                ...
                <div className="widget-container py-4 flex flex-col items-center md:flex-row md:items-start">
                  <div className="widget-icon-container md:mr-1">
                    <BiImages className="text-5xl text-[#ff702d]" />
                  </div>
                  <div className="widget-content flex-center flex-col text-center md:text-left">
                    <h3 className="text-4xl md:text-4xl">Architecture</h3>
                    <p className="mt-2">
                ...
                <div className="widget-container py-4 flex flex-col items-center md:flex-row md:items-start">
                  <div className="widget-icon-container md:mr-1">
                    <BiHourglass className="text-5xl text-[#ff702d]" />
                  </div>
                  <div className="widget-content flex-center flex-col text-center md:text-left">
                    <h3 className="text-4xl md:text-4xl">Architecture</h3>
                    <p className="mt-2">
