      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex md:space-x-4">
            <a href="#" className="text-gray-300  px-3 py-2 rounded-md text-base font-medium">Home</a>
            <a href="#" className="text-gray-300  px-3 py-2 rounded-md text-base font-medium">About</a>
            <a href="#" className="text-gray-300  px-3 py-2 rounded-md text-base font-medium">Services</a>
            <a href="#" className="text-gray-300  px-3 py-2 rounded-md text-base font-medium">Projects</a>
            <a href="#" className="text-gray-300  px-3 py-2 rounded-md text-base font-medium">Contact</a>
          </div>
